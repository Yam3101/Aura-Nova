...
export default function Home() {
	...
	const galleryItems = useMemo(
		() => [
			...media.exterior.slice(0, 2),
			...media.interior.slice(0, 2),
			...media.amenidades.slice(0, 2),
		],
		[],
	);
					...
					<div className="max-w-2xl animate-fade-up">
						...
						<div className="mt-8 grid gap-3 sm:grid-cols-3">
							...
							<div className="rounded-2xl border border-brand-border bg-white/80 p-4 backdrop-blur">
								...
								<p className="mt-1 text-lg font-bold">
									Alberca · Cancha · Dog park · Palapas
								</p>
							</div>
							<div className="rounded-2xl border border-brand-border bg-white/80 p-4 backdrop-blur">
								<p className="text-xs font-semibold text-brand-muted">
							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="mt-1 text-sm text-brand-muted">
										Tu vivienda a un precio adaptado a nuestros clientes.
									</p>
								</div>
							</div>
						</Card>
						<Card>
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="mt-1 text-sm text-brand-muted">
										Te asesoramos en tu proceso de compra con Infonavit para que
						...
						<Card>
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="mt-1 text-sm text-brand-muted">
										Ubicación y referencia para agendar visita.
									</p>
								</div>
							</div>
						</Card>
